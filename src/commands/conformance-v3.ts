...
async function conformanceGet(inputs: string[], context: Context) {
...
async function clientMockInitiate(context: Context) {
  const apiUrl = context.config.api.conformance.url;
...
async function clientMockUpdateList(inputs: string[], context: Context) {
...
async function authMockAuthorize(inputs: unknown, context: Context) {
  const [
...
async function authMockDirectPostIdToken(inputs: unknown, context: Context) {
...
async function authMockDirectPostVpToken(inputs: unknown[]) {
...
async function authMockToken(inputs: unknown, context: Context) {
  const [
    openIdCredentialIssuer,
    openIdConfiguration,
    code,
...
async function issuerMockCredential(inputs: unknown, context: Context) {
...
async function issuerMockDeferred(inputs: unknown[]) {
...
async function issuerMockInitiateCredentialOffer(
  inputs: unknown,
  context: Context
) {
...
async function getCredential(inputs: unknown, context: Context) {
  ...
  console.log(
    `==> conformance get ${authorizationServer}/.well-known/openid-configuration`
  );
  ...
  console.log(
    `==> conformance authMockAuthorize ${stringify(opIssuer, [
  ...
  if (type === "roottao") {
    ...
    console.log(
      `==> conformance authMockDirectPostVpToken ${stringify(opConf, [
        "redirect_uris",
    ...
    console.log(
      `==> conformance authMockDirectPostIdToken ${stringify(opIssuer, [
        "authorization_server",
        "credential_issuer",
  ...
  console.log(
    `==> conformance authMockToken ${stringify(opIssuer, [
      "authorization_server",
      "credential_issuer",
  ...
  console.log(
    `==> conformance issuerMockCredential ${stringify(opIssuer, [
      "credential_issuer",
  ...
  if (type === "roottao") {
    ...
    console.log(
      `==> conformance issuerMockDeferred ${stringify(opIssuer, [
...
async function holder(inputs: unknown, context: Context) {
  const apiUrl = context.config.api.conformance.url;
...
async function check(inputs: unknown, context: Context) {
...
export async function conformanceV3(
  method: string,
